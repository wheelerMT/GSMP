...
// // C Includes
// #include "variable_manager_api.h"
...
//     if (instance != nullptr)
//     {
//         std::cerr << "[ERROR] Non-null pointer passed to GSMP_VariableManager_Create. Instance already
...
//     {
//         // TODO Utility:ErrorMessage e.g. int ErrorMessage(returnCode, const char*) - which always returns 'ERROR' or
//         a
...
//     } catch (const std::exception &ex)
//     {
//         std::cerr << "[ERROR] Exception caught in GSMP_VariableManager_Destroy while deleting instance: " <<
//         ex.what()
//                   << '\n';
//         return ERROR;
//     } catch (...)
